		...
		const { data, error } = await resend.emails.send({
			...
			html: `
			  <div style="font-family: 'DM Sans', Inter, sans-serif; background: #1A103D; color: #E1D7FE; padding: 24px; border-radius: 12px;">
			    <h1 style="margin: 0 0 8px 0; color: #A259F7;">Votre table est confirmée ✨</h1>
			    <p style="margin: 0 0 18px 0; color: #B8B3C6;">Merci pour votre réservation sur NightTable.</p>
			    <ul style="line-height: 1.8; color: #E1D7FE;">
