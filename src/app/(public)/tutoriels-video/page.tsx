...
export const metadata: Metadata = {
  title: "Tutoriels vidéo | NightTable",
  description: "Tutoriels vidéo pour prendre en main NightTable rapidement.",
};
  ...
  return (
    <main className="min-h-screen bg-[#050508] px-6 py-16 text-[#F7F6F3]">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-3 text-[36px] font-semibold leading-tight">Tutoriels vidéo</h1>
        <p className="mt-4 text-base leading-relaxed text-[#888888]">
          Les tutoriels vidéo arrivent prochainement pour former vos équipes en quelques minutes.
        </p>
        <div className="mt-8">
          <Link
            href="/demo"
